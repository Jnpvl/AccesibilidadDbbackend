...
exports.requireExportExcel = void 0;
const jwt_utils_1 = require("../utils/jwt.utils");
const database_1 = require("../config/database");
const usuarios_entities_1 = require("../entities/usuarios.entities");
const requireExportExcel = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!user.canExportExcel) {
            res.status(403).json({ message: "No tienes permisos para exportar Excel" });
            return;
        }
        req.user = user;
        next();
...
exports.requireExportExcel = requireExportExcel;
